...
function Home() {
  ...
  const handleSearch = async (e) => {
    ...
    const selectedTags = [flavor, cost, time, difficulty]
      .filter((tag) => tag !== "普通")
      .join(",");
      ...
      <div className="w-full max-w-3xl space-y-12">
        ...
        <div className="space-y-4 w-full max-w-md mx-auto">
          ...
          <div className="w-full">
            <button
              className={`w-full flex justify-between items-center bg-orange-100 border-2 border-orange-300 text-orange-800 hover:bg-orange-200 hover:text-orange-900 px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-opacity-50 ${
            ...
            {isOpen && (
              <div
                id="detailed-search"
                className="bg-orange-50 p-6 rounded-b-lg shadow-md border-2 border-t-0 border-orange-200"
              >
